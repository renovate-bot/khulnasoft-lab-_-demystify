...
import (
	...
	"github.com/khulnasoft-lab/demystify/runtime/ci"
	"github.com/khulnasoft-lab/demystify/runtime/export"
	"github.com/khulnasoft-lab/demystify/runtime/ui"
	"github.com/khulnasoft-lab/demystify/utils"
)
...
func Run(options Options) {
	...
	imageResolver, err := demystify.GetImageResolver(options.Source)
	if err != nil {
