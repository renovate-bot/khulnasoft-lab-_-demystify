...
import (
	...
	"github.com/khulnasoft-lab/demystify/demystify/image/docker"
)
...
func TestRun(t *testing.T) {
	table := map[string]struct {
		...
		"fetch-case": {
			...
			options: Options{
				Ci:         false,
				Image:      "demystify-example",
				Source:     demystify.SourceDockerEngine,
				ExportFile: "",
				CiConfig:   nil,
				BuildArgs:  nil,
			},
			events: []testEvent{
				{stdout: "Image Source: docker://demystify-example", stderr: "", errorOnExit: false, errMessage: ""},
